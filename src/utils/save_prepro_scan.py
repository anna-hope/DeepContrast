...
def save_prepro_scan(
    ...
    for fn, ID in zip(fns, IDs):
        ...
        img_reg = nrrd_reg_rigid_ref(
            img_nrrd=img_nrrd, fixed_img_dir=fixed_img_dir, patient_id=ID, save_dir=None
        )
...
if __name__ == "__main__":
    ...
    MDACC_reg_dir = (
        "/mnt/aertslab/USERS/Zezhong/constrast_detection/data/MDACC_data_reg"
    )
